...
kubectl create secret docker-registry private-registry --docker-server=ironbanksrc.azurecr.us --docker-username="${IRON_BANK_USER}" --docker-password="${IRON_BANK_PAT}" -n flux-system
